...
A native iOS maps app: Apple Maps' look, feel, and native MapKit rendering — with Google Maps–style rich place details (photos, ratings, reviews, hours) layered on top via the Google Places API.
...
4. Generate the Xcode project:
   ...
   xcodegen generate
   ```
5. Open `Waypoint.xcodeproj` and run on an iOS 17+ simulator or device.
